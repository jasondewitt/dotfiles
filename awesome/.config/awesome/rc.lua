...
local modkey       = "Mod4"
local altkey       = "Mod1"
local terminal     = "terminator --geometry=1200x800" or "xterm"
...
globalkeys = awful.util.table.join(
    -- replacing default super+r run prompt with rofi run
    awful.key({ modkey, }, "r", function () awful.spawn.with_shell("rofi -show run") end, { tag = mouse.screen.selected_tag } ),
    awful.key({ modkey, }, "s", function () awful.spawn("rofi -show ssh") end, { tag = mouse.screen.selected_tag } ),
    ...
    --]]
    -- Prompt
    -- commenting out default run prompt in favor of rofi
...
awful.rules.rules = {
    ...
    { rule = { class = "Atom" },
      properties = { screen = 1, tag = screen[2].tags[2] } },

    { rule = { class = "Gimp" },
          properties = { screen = 1, tag = screen[2].tags[7] } },
}
-- }}}
