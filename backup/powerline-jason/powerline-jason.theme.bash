...
. "$BASH_IT/themes/powerline-jason/powerline-jason.base.bash"
...
PYTHON_VENV_THEME_PROMPT_COLOR=208
PYTHON_VENV_THEME_PROMPT_FG_COLOR=15
...
POWERLINE_PROMPT=${POWERLINE_PROMPT:="python_venv scm cwd"}
