...
txtaws="$(tput setaf 208 2>/dev/null || echo '\033[38;5;208m')"             # aws orange
txtgitbranch="$(tput setaf 39 2>/dev/null || echo '\033[38;5;39m')"         # git branch color
txtgitdirty="$(tput setaf 160 2>/dev/null || echo '\033[38;5;160m')"         # git dirty color
